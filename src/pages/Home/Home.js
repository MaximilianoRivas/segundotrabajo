...
<main className="d-flex justify-content-center align-items-center">
        ...
        <div className="conteiner">
            ...
            <h2 className='titulo'>Helcome to Rick & Morty Proyect!</h2>
            <p className='parrafo'>This proyect was made for practising React and to made a functional website</p>

           <p className='parrafo2'> In this website you can know information of the characters of this animated series.
            <br/> Also you can filter for diferent types of properties to find the character that you are looking for or send us a massage for any concern o sugestion</p>
            <h3 className='go'>Lets go!</h3>
            <div className='hol'>
            <nav className='row navba align-items-center'>

            <ul className='nav nav-pills '>

            <li className='nav-item'>

            <Link to="/characters" className='botones'>Charactes</Link>
            
            </li>
            <li className='nav-item'>
            
            <Link to="/contact" className='botones1'>Contact</Link>       
